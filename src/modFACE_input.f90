...
if(timestep_adjusted_reduction_string.eq."yes") then
    ...
    subroutine parse_keywords()
        ...
        call get_keyword_value('Edes_satleft', Edes_lsat)
        call get_keyword_value('Edes_satright', Edes_rsat)
        ...
        call get_keyword_value('thermal_conductivity', thcond_region1)
        call get_keyword_value('thermal_conductivity_region2', thcond_region2)
        call get_keyword_value('thermal_conductivity_profile', thcond_profile_string)
        call get_keyword_value('thermal_conductivity_xmax', thcond_xmax)
